TODO:
install/require inquirer for CLI interaction 

WHEN I start the application
THEN I am presented with options: view all departments...
...
TODO:  your schema should contain the following three tables:
department
id: INT PRIMARY KEY
